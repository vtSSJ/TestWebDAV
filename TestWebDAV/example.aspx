...
<%@ Import Namespace="CIPort.WebDAV.Properties" %>
...
//		DirectoryInfo _dirInfo = new DirectoryInfo(AppSettings.Settings.Default.RepositoryPath);
        DirectoryInfo _dirInfo = new DirectoryInfo("E:\\tmp");
...
<body>
	...
	<div>
		...
		<p align="center"><a href="ms-word:http://localhost:49416/tz.doc">Test</a>
		...
		<table cellpadding="5" cellspacing="5" width="100%">
			...
			<tr>
				...
				<td>
					...
					<br />
					<br />
                    <a href="ms-word:http://localhost:54840/tmp/tz2.doc">tmp/tz2.doc</a>
					<asp:Repeater ID="fileInfo" runat="server">
						...
						<ItemTemplate>
							<tr>
								<td align="center">
									<a href="<%# Path.GetExtension(((FileInfo)Container.DataItem).Name)==".doc"? "ms-word" : "ms-excel" %>:<%# this.WebDAVRepositoryRoot + ((FileInfo)Container.DataItem).Name %>">
